                    ...
                    <div class="card">
                        ...
                        <?php if ($this->session->userdata('level') == 'admin' || $this->session->userdata('level') == 'bidan') { ?>
                            <div class="card-header posyandu-header">
                                ...
                                ?>
                                    <a href="<?php echo base_url("jadwal_ibu/posyandu/$posyandu->id"); ?>" class="btn btn-info"><?= $posyandu->nama ?></a>
                                <?php
                                }
                                ?>
                            </div>
                                            ...
                                            foreach ($jadwal_ibu_data as $jadwal_ibu) { ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php if ($jadwal_ibu->status == 0 && ($this->session->userdata('level') == 'admin' || $this->session->userdata('level') == 'kader')) { ?>
                        ...
                        <div class="card-footer">
                            ...
                            ?>
                            <a href=" <?php echo base_url("jadwal_ibu/cetak_pdf/$id"); ?>" class="btn btn-info">Cetak Data Jadwal Ibu</a>
