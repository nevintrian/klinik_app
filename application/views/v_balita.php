<div class="content-wrapper">
    ...
    <section class="content">
        <div class="container-fluid">
                    ...
                    <div class="card">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($balita_data as $balita) { ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href=" <?php echo base_url("balita/detail/$balita->nik"); ?>" class="btn btn-primary"><i class="fa fa-eye"></i></a>
                        ...
                        <div class="card-footer">
                            ...
                            <a href=" <?php echo base_url("balita/cetak_pdf/$id"); ?>" class="btn btn-info">Cetak Data Balita</a>
                             <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal">Cetak Data Filter Bulan</button>
                             <button type="button" class="btn btn-secondary" data-toggle="modal" data-target="#myModalImunisasi">Cetak Data Filter Imunisasi</button>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                             <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label>Filter Imunisasi</label>
                                    <select name="filter_imunisasi" id="filter_imunisasi" class="form-control" required>
                                        <option value="">-- Pilih Imunisasi --</option>
                                        <option value="0">Semua Imunisasi</option>
                                        <?php foreach ($imunisasi_balita_data as $imunisasi) : ?>
            ...
            <div id="myModalImunisasi" class="modal fade" role="dialog">
                    <div class="modal-dialog">
                     <?php
                            $id = basename($_SERVER['REQUEST_URI']);
                        ?>
                    ...
                    <fieldset class="show" id="tab011">
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="jenis_kelamin" id="jenis_kelamin" class="form-control jenis_kelamin" required>
