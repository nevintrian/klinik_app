								...
								<div class="card-body p-0">
									<table class="table table-bordered table-responsive-md" id="datatables">
										...
										<tbody>
											<?php
											$i = 1;
											foreach ($obat_kategori_data as $obat_kategori) { ?>
												<tr>
													<td style="width: 10px"><?= $i ?></td>
													<td><?= $obat_kategori->nama ?></td>
													<td>
														<a href="#" class="btn btn-primary btn-view mb-1" data-id="<?= $obat_kategori->id; ?>" data-nama="<?= $obat_kategori->nama; ?>"><i class="fa fa-eye"></i></a>
														<a href="#" class="btn btn-info btn-edit mb-1" data-id="<?= $obat_kategori->id; ?>" data-nama="<?= $obat_kategori->nama; ?>"><i class="fa fa-marker"></i></a>
														<a href="#" class="btn btn-danger btn-delete mb-1" data-id="<?= $obat_kategori->id; ?>"><i class="fa fa-trash"></i></a>
													</td>
												</tr>
											<?php
												$i++;
