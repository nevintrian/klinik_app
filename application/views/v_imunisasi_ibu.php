                ...
                <div class="col-12">
                    <div class="card">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($imunisasi_ibu_data as $imunisasi_ibu) { ?>
                                                <tr>
                                                    ...
                                                    <td><?= $imunisasi_ibu->deskripsi ?></td>
                                                    <td>
                                                        <a href="#" class="btn btn-primary btn-view" data-id="<?= $imunisasi_ibu->id; ?>" data-nama="<?= $imunisasi_ibu->nama; ?>" data-deskripsi="<?= $imunisasi_ibu->deskripsi; ?>" ><i class="fa fa-eye"></i></a>
                                                        <a href="#" class="btn btn-info btn-edit" data-id="<?= $imunisasi_ibu->id; ?>" data-nama="<?= $imunisasi_ibu->nama; ?>" data-deskripsi="<?= $imunisasi_ibu->deskripsi; ?>"><i class="fa fa-marker"></i></a>
                                                        <a href="#" class="btn btn-danger btn-delete" data-id="<?= $imunisasi_ibu->id; ?>"><i class="fa fa-trash"></i></a>
                                                        <a href="<?php echo base_url("ibu/imunisasi/$imunisasi_ibu->id"); ?>" class="btn btn-secondary">Lihat Peserta</a>
                                                    </td>
                                                </tr>
                                            <?php
                                                $i++;
                        ...
                        <div class="card-footer">
                            <a href="imunisasi_ibu/cetak_pdf" class="btn btn-info">Cetak Data Imunisasi Ibu</a>
                        </div>
                    </div>
                </div>
            </div>
